      ...
      <div className="blend-detail-container">
        ...
        <div className="blend-detail-left">
          ...
          <div className="blend-description">
            ...
            <p>
              Body, acidity, and sweetness are key components in sensory
              evaluation, particularly in wine and coffee, defining the
              flavor profile, mouthfeel, and balance of the product.
              These characteristics determine how a beverage feels
              and tastes on the palate.
            </p>

          </div>

          <button
            className="blend-back"
